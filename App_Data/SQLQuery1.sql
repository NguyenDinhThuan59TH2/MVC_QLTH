...
insert into DonHangNhap values
	('DHN1','NCC1','2020/01/01','10',N'%', '1', '0'),
	('DHN2','NCC2','2020/01/01','10000',N'VNĐ', '1', '0'),
	('DHN3','NCC3','2020/01/01','20000',N'VNĐ', '1', '0'),
	('DHN4','NCC4','2020/01/01','15',N'%', '1', '0'),
	('DHN5','NCC5','2020/01/01','25',N'%', '0', '0')


insert into DonHangXuat values
	('DHX1','KH1','2020/02/02','10',N'%', '1', '0'),
	('DHX2','KH2','2020/04/03','10000',N'VNĐ', '1', '0'),
	('DHX3','KH3','2020/03/04','20000',N'VNĐ', '1', '0'),
	('DHX4','KH4','2020/05/05','15',N'%', '1', '0'),
	('DHX5','KH5','2020/02/02','25',N'%', '1', '0')

insert into DonHangDat values
	('DHD1','KH2','2020/02/02',NULL,NULL,NULL,N'Đang đặt', '0'),
	('DHD2','KH3','2020/02/02','2020/02/02',NULL,NULL,N'Đã đặt', '0'),
	('DHD3','KH4','2020/02/02','2020/02/02','2020/02/02',NULL,N'Đang giao', '0'),
	('DHD4','KH5','2020/02/02','2020/02/02','2020/02/02','2020/02/02',N'Đã thanh toán', '0')
